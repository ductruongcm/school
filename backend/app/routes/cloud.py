...
from app.db_utils.db_cloud_ultis import db_upload, db_show_folder, db_hide_file, db_unhide_file, db_delete
...
def upload():
    ...
    url = cloud_upload(class_room, file_name)
    db_upload(username, file_name, file_size, file_type, class_room)
