...
class Students(db.Model):
    ...
    retest = db.relationship('Retest', back_populates = 'students', lazy = True)
    @validates('name')
...
class Student_Period_Summary(db.Model):
    ...
    __table_args__ = (UniqueConstraint('student_id', 'period_id', name = 'stu_per_uniq'),)
...
class Student_Year_Summary(db.Model):
    ...
    retest_status = db.Column(db.Boolean)
...
class Attendence(db.Model):
    ...
    period = db.relationship('Period', back_populates = 'attendence', lazy = True)
    __table_args__ = (UniqueConstraint('student_id', 'date', name='stu_date_uniq'),)
